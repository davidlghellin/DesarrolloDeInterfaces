...
public class EditorPanelFun extends JPanel
{
	private static final Integer[]	ITEMS			= { 9, 10, 11, 12, 14, 16,
			18, 20, 24, 32							};
	...
	private static void createAndShowGui()
	{
		...
		frame.getContentPane().add(new EditorPanelFun());
		frame.pack();

...
//			add(botonCambiarColor);
	...
	class MenuEditorBarra extends JMenuBar
	{
		...
		public MenuEditorBarra()
		{
			...
			// Estilos
			jmEstilo.add(jmNegrita = new JMenuItem(new ImageIcon("src/iconos/bold-2x.png")));
			jmEstilo.add(jmCursiva = new JMenuItem(new ImageIcon("src/iconos/italic-2x.png")));
